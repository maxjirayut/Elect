...
include 'Connect.php';
include 'CheckLogUser.php';
?>
<div class="container">
  <form action="Update_User.php?Number_ID=<?php echo $objResult['Number_ID']?>" method="post">
    <div class="form-group">
      <label >รหัสนักศึกษา</label>
      <input type="text" readonly  class="form-control" required   value="<?php echo $objResult['Number_Code']; ?>" name="Number_Code">
    </div>
    <div class="form-group">
      <label >รหัสบัตรประจำตัวประชาชน</label>
      <input type="number" class="form-control" required  value="<?php echo $objResult['Number_User']; ?>" name="Number_User">
    </div>
    <div class="form-group">
      <label>สาขา</label>
     <select name="Number_Sub"  class="form-control">
       <option value="<?php echo $objResult['Number_Sub']; ?>"><?php echo $objResult['Number_Sub']; ?></option>
    ...
    <div class="form-group">
      <label>ชื่อ</label>
      <input type="text" class="form-control" required  value="<?php echo $objResult['Number_Name']; ?>" name="Number_Name">
    </div>
    <div class="form-group">
      <label>เบอร์โทรศัพท์</label>
      <input type="number" class="form-control" required placeholder="เบอร์โทรศัพท์" value="<?php echo $objResult['Number_Phone'] ;?>" name="Number_Phone">
    </div>
